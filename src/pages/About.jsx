...
<BannerReuse image={Bgimage} title="About us" />
        ...
        <section className='h-lvh flex flex-col gap-20 mb-20 '>
          <div className='text-center flex flex-col gap-2'>

          <h1 className='text-4xl font-poppins font-bold text-[#222222]'>What Kind of Services we Offer</h1>
          <p className='text-[#777777]'>Who are in extremely love with eco friendly system.</p>
          </div>
          <div className='grid grid-cols-3 w-11/12 m-auto pl-7   '>
            {
              aboutitem.map((val,i)=>{
                return(

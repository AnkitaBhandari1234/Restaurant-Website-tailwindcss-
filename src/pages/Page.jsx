  ...
  return (
    <div className='overflow-hidden bg-[#f9f9ff]'>
      ...
      <div className='w-10/12 py-28 mx-auto '>
        <h1 className='text-2xl font-bold font-poppins text-gray-800 mb-8'>Text Sample</h1>
        ...
        <Button />
        <Aligntext />
        <div className='w-11/12 flex flex-col gap-6 items-center mx-auto   '>
          <h1 className='w-11/12 text-2xl font-semibold font-poppins   '>Definition</h1>
        ...
        <div className='flex flex-col gap-10 py-28 w-11/12 mx-auto'>
          ...
          <span className='  h-48 border-[1.5px] border-red-400 rounded-2xl font-bold w-fit '></span>

  ...
  return (
    <div>
      <div>
        ...
        <img src={Blogbgimg} className='w-full h-[850px] object-cover'></img>
        <div className='absolute top-0 bottom-0 left-0 right-0 w-full h-[1110px] flex flex-col justify-center items-center gap-5 z-10 '>
          <h1 className='text-4xl text-white font-bold font-poppins w-5/12  text-center tracking-wide  '>Dude You’re Getting a Telescope</h1>
          <p className='text-white font-poppins'>There is a moment in the life of any aspiring astronomer that it is time to buy that first</p>
          <button type='submit' className='text-black bg-white uppercase px-8 py-3 text-center font-poppins text-sm font-bold'>view more</button>
        </div>
   ...
   <div>
    ...
    <div className='flex flex-row gap-3 items-center w-5/12 mx-auto text-gray-600 py-24 '>
    ...
    <span className='text-xl '><IoIosArrowForward />
    </span>
    </div>
    </div>
  )

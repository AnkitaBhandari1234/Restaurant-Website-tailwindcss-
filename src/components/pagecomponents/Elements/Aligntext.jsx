  ...
  return (
    <div className='py-28 flex flex-col gap-30 col'>
        <div className='flex flex-col gap-6'>
            <h1 className='font-bold text-2xl font-poppins text-gray-800 ml-18'>Left Aligned</h1>
            <div className='flex gap-10 w-11/12 mx-auto  items-center px-5'>
        ...
        <div className='flex flex-col gap-6'>
            <h1 className='font-bold text-2xl font-poppins text-gray-800 text-right mr-18 '>Right Aligned</h1>
            <div className='flex flex-row-reverse gap-10 w-11/12 mx-auto  items-center px-5'>
                <img src={Alignedimg}></img>

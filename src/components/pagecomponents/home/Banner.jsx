...
function Banner() {
  return (
    <div className="">
        <img src={Bgimage} alt='banner-img' className=' absolute top-0 left-0 right-0 bottom-0 h-lvh '></img>
     
    <section className="relative pt-32">
      <div className="w-full mx-4  lg:w-9/12 flex flex-col gap-7 lg:mx-16 my-20   ">
        ...
        <div className= "text-white text-md lg:font-light lg:-tracking-tight  w-11/12 lg:w-7/12 ">
          <h3>

...
function BannerReuse({
  ...
  return (
    <div className="relative w-screen overflow-hidden h-[490px] ">
    <div className='bg-linear-to-r from-black/30 to-black/60 absolute top-0 bottom-0 left-0 right-0   z-10 '></div>
      ...
      <section className=' relative top-0 left-0  pt-10 items-center lg:h-full h-[690px]  right-0 bottom-0 flex flex-col gap-2 justify-center w-9/12 m-auto z-20 '>
